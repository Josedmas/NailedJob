...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    jobOfferTitleLabel: 'Job Title (from offer)',
    jobOfferTitlePlaceholder: 'e.g., Senior Software Engineer',
    jobOfferTextLabel: 'Job Offer Text/Description',
    ...
    aiCraftedResumeDescription: "This resume has been tailored for the job offer. Review and edit the content, then download it.",
  ...
  es: {
    ...
    jobOfferTitleLabel: 'Título del Puesto (de la oferta)',
    jobOfferTitlePlaceholder: 'Ej: Ingeniero de Software Senior',
    jobOfferTextLabel: 'Texto/Descripción de la Oferta de Empleo',
    ...
    aiCraftedResumeDescription: "Este currículum ha sido adaptado para la oferta de empleo. Revisa y edita el contenido, luego descárgalo.",
